...
<template>
    <div class="w-full max-w-lg px-4">
        <div class="card flex flex-col items-center overflow-hidden">
            <div class="w-full p-10 sm:p-12 flex flex-col items-center">
                ...
                <form @submit.prevent="submit" class="w-full px-2 sm:px-4">
                    <div class="flex flex-col gap-6">
                        ...
                        <Button type="submit" :label="t('login.signIn')" class="w-full mt-1" :loading="form.processing" />
                    </div>
                </form>

                <div class="mt-10 flex justify-center items-center gap-3 text-slate-500">
