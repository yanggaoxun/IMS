...
<template>
    <div class="grid grid-cols-12 gap-6">
        <div class="col-span-12">
            <div class="card">
                <div class="flex items-center justify-between mb-4">
                    <h3 class="font-semibold text-lg">Toolbar</h3>
                </div>
                <Toolbar>
                    <template #start>
        ...
        <div class="col-span-12 lg:col-span-6 flex flex-col gap-6">
            <div class="card">
                <div class="flex items-center justify-between mb-4">
                    <h3 class="font-semibold text-lg">Accordion</h3>
                </div>
                <Accordion value="0">
            ...
            <div class="card">
                <div class="flex items-center justify-between mb-4">
                    <h3 class="font-semibold text-lg">Tabs</h3>
                </div>
                <Tabs value="0">
                    <TabList>
        ...
        <div class="col-span-12 lg:col-span-6 flex flex-col gap-6">
            <div class="card">
                <div class="flex items-center justify-between mb-4">
                    <h3 class="font-semibold text-lg">Panel</h3>
                </div>
            ...
            <div class="card">
                <div class="flex items-center justify-between mb-4">
                    <h3 class="font-semibold text-lg">Fieldset</h3>
                </div>
            ...
            <Card>
                <template v-slot:title>
                    <div class="flex items-center justify-between mb-0">
                        <div class="flex items-center justify-between mb-4">
                            <h3 class="font-semibold text-lg">Card</h3>
                        </div>
        ...
        <div class="col-span-12">
            <div class="card">
                <div class="flex items-center justify-between mb-4">
                    <h3 class="font-semibold text-lg">Divider</h3>
                </div>
        ...
        <div class="col-span-12">
            <div class="card">
                <div class="flex items-center justify-between mb-4">
                    <h3 class="font-semibold text-lg">Splitter</h3>
                </div>
