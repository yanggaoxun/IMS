...
<template>
    <div class="grid grid-cols-12 gap-6">
        <div class="col-span-12 lg:col-span-6">
            <div class="card">
                <div class="flex items-center justify-between mb-4">
                    <h3 class="font-semibold text-lg">Default</h3>
                </div>
            ...
            <div class="card">
                <div class="flex items-center justify-between mb-4">
                    <h3 class="font-semibold text-lg">Severities</h3>
                </div>
                <div class="flex flex-wrap gap-2">
            ...
            <div class="card">
                <div class="flex items-center justify-between mb-4">
                    <h3 class="font-semibold text-lg">Text</h3>
                </div>
                <div class="flex flex-wrap gap-2">
            ...
            <div class="card">
                <div class="flex items-center justify-between mb-4">
                    <h3 class="font-semibold text-lg">Outlined</h3>
                </div>
                <div class="flex flex-wrap gap-2">
            ...
            <div class="card">
                <div class="flex items-center justify-between mb-4">
                    <h3 class="font-semibold text-lg">Group</h3>
                </div>
                <div class="flex flex-wrap gap-2">
                    <ButtonGroup>
            ...
            <div class="card">
                <div class="flex items-center justify-between mb-4">
                    <h3 class="font-semibold text-lg">SplitButton</h3>
                </div>
                <div class="flex flex-wrap gap-2">
            ...
            <div class="card">
                <div class="flex items-center justify-between mb-4">
                    <h3 class="font-semibold text-lg">Templating</h3>
                </div>
                <div class="flex flex-wrap gap-2">
                    <Button type="button">
        ...
        <div class="col-span-12 lg:col-span-6">
            ...
            <div class="card">
                <div class="flex items-center justify-between mb-4">
                    <h3 class="font-semibold text-lg">Raised</h3>
                </div>
                <div class="flex flex-wrap gap-2">
            ...
            <div class="card">
                <div class="flex items-center justify-between mb-4">
                    <h3 class="font-semibold text-lg">Rounded</h3>
                </div>
                <div class="flex flex-wrap gap-2">
            ...
            <div class="card">
                <div class="flex items-center justify-between mb-4">
                    <h3 class="font-semibold text-lg">Rounded Icons</h3>
                </div>
                <div class="flex flex-wrap gap-2">
            ...
            <div class="card">
                <div class="flex items-center justify-between mb-4">
                    <h3 class="font-semibold text-lg">Rounded Text</h3>
                </div>
                <div class="flex flex-wrap gap-2">
            ...
            <div class="card">
                <div class="flex items-center justify-between mb-4">
                    <h3 class="font-semibold text-lg">Rounded Outlined</h3>
                </div>
                <div class="flex flex-wrap gap-2">
