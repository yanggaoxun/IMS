    ...
    <Fluid>
        <div class="grid grid-cols-12 gap-6">
            <div class="col-span-12 lg:col-span-6 flex flex-col gap-6">
                <div class="card flex flex-col gap-4">
                    <div class="flex items-center justify-between mb-4">
                        <h3 class="font-semibold text-lg">InputText</h3>
                    </div>
                    ...
                    <div class="flex items-center justify-between mb-4">
                        <h3 class="font-semibold text-lg">Icons</h3>
                    </div>
                    <IconField>
                    ...
                    <div class="flex items-center justify-between mb-4">
                        <h3 class="font-semibold text-lg">Float Label</h3>
                    </div>
                    <FloatLabel>
                    ...
                    <div class="flex items-center justify-between mb-4">
                        <h3 class="font-semibold text-lg">Textarea</h3>
                    </div>
                    <Textarea placeholder="Your Message" :autoResize="true" rows="3" cols="30" />

                    <div class="flex items-center justify-between mb-4">
                        <h3 class="font-semibold text-lg">AutoComplete</h3>
                    </div>
                    ...
                    <div class="flex items-center justify-between mb-4">
                        <h3 class="font-semibold text-lg">DatePicker</h3>
                    </div>
                    <DatePicker :showIcon="true" :showButtonBar="true" v-model="calendarValue"></DatePicker>

                    <div class="flex items-center justify-between mb-4">
                        <h3 class="font-semibold text-lg">InputNumber</h3>
                    </div>
                ...
                <div class="card flex flex-col gap-4">
                    <div class="flex items-center justify-between mb-4">
                        <h3 class="font-semibold text-lg">Slider</h3>
                    </div>
                    ...
                    <div class="flex flex-row mt-6">
                        ...
                        <div class="flex flex-col gap-4 w-1/2">
                            <div class="flex items-center justify-between mb-4">
                                <h3 class="font-semibold text-lg">ColorPicker</h3>
                            </div>
                    ...
                    <div class="flex items-center justify-between mb-4">
                        <h3 class="font-semibold text-lg">Knob</h3>
                    </div>
            ...
            <div class="col-span-12 lg:col-span-6 flex flex-col gap-6">
                <div class="card flex flex-col gap-4">
                    <div class="flex items-center justify-between mb-4">
                        <h3 class="font-semibold text-lg">RadioButton</h3>
                    </div>
                    <div class="flex flex-col md:flex-row gap-4">
                    ...
                    <div class="flex items-center justify-between mb-4">
                        <h3 class="font-semibold text-lg">Checkbox</h3>
                    </div>
                    <div class="flex flex-col md:flex-row gap-4">
                        <div class="flex items-center">
                    ...
                    <div class="flex items-center justify-between mb-4">
                        <h3 class="font-semibold text-lg">ToggleSwitch</h3>
                    </div>
                ...
                <div class="card flex flex-col gap-4">
                    <div class="flex items-center justify-between mb-4">
                        <h3 class="font-semibold text-lg">Listbox</h3>
                    </div>
                    ...
                    <div class="flex items-center justify-between mb-4">
                        <h3 class="font-semibold text-lg">MultiSelect</h3>
                    </div>
                    ...
                    <div class="flex items-center justify-between mb-4">
                        <h3 class="font-semibold text-lg">TreeSelect</h3>
                    </div>
                ...
                <div class="card flex flex-col gap-4">
                    <div class="flex items-center justify-between mb-4">
                        <h3 class="font-semibold text-lg">ToggleButton</h3>
                    </div>
                    <ToggleButton v-model="toggleValue" onLabel="Yes" offLabel="No" :style="{ width: '10em' }" />

                    <div class="flex items-center justify-between mb-4">
                        <h3 class="font-semibold text-lg">SelectButton</h3>
                    </div>
        ...
        <div class="grid grid-cols-12 gap-6">
            <div class="col-span-12">
                <div class="card flex flex-col gap-4 w-full">
                    <div class="flex items-center justify-between mb-4">
                        <h3 class="font-semibold text-lg">InputGroup</h3>
                    </div>
                    <div class="flex flex-col md:flex-row gap-4">
                        <InputGroup>
                            <InputGroupAddon>
