...
<template>
    <div class="grid grid-cols-12 gap-6">
        <div class="col-span-12">
            <div class="card">
                <div class="flex items-center justify-between mb-4">
                    <h3 class="font-semibold text-lg">Menubar</h3>
                </div>
        ...
        <div class="col-span-12">
            <div class="card">
                <div class="flex items-center justify-between mb-4">
                    <h3 class="font-semibold text-lg">Breadcrumb</h3>
                </div>
        ...
        <div class="col-span-12 md:col-span-6">
            <div class="card">
                <div class="flex items-center justify-between mb-4">
                    <h3 class="font-semibold text-lg">TabMenu</h3>
                </div>
                <Tabs value="0">
                    <TabList>
        ...
        <div class="col-span-12 md:col-span-4">
            <div class="card">
                <div class="flex items-center justify-between mb-4">
                    <h3 class="font-semibold text-lg">Tiered Menu</h3>
                </div>
        ...
        <div class="col-span-12 md:col-span-4">
            <div class="card">
                <div class="flex items-center justify-between mb-4">
                    <h3 class="font-semibold text-lg">Plain Menu</h3>
                </div>
        ...
        <div class="col-span-12 md:col-span-4 flex flex-col gap-6">
            ...
            <div class="card" @contextmenu="onContextRightClick">
                <div class="flex items-center justify-between mb-4">
                    <h3 class="font-semibold text-lg">Context Menu</h3>
                </div>
        ...
        <div class="col-span-12 md:col-span-6">
            <div class="card">
                <div class="flex items-center justify-between mb-4">
                    <h3 class="font-semibold text-lg">MegaMenu | Horizontal</h3>
                </div>
                <MegaMenu :model="megamenuItems" />

                <div class="flex items-center justify-between mb-4 mt-8">
                    <h3 class="font-semibold text-lg">MegaMenu | Vertical</h3>
                </div>
        ...
        <div class="col-span-12 md:col-span-6">
            <div class="card">
                <div class="flex items-center justify-between mb-4">
                    <h3 class="font-semibold text-lg">PanelMenu</h3>
                </div>
